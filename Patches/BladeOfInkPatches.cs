...
static class BladeOfInk_OnPlay_Patch
{
    ...
    static async Task OldOnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay, BladeOfInk instance)
    {
        ...
        await PowerCmd.Apply<BladeOfInkPower>(choiceContext, instance.Owner.Creature, instance.DynamicVars.Strength.IntValue, instance.Owner.Creature, instance);
    }
}
...
static class BladeOfInk_Description_Patch
{
